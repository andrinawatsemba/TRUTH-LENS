...
User → Frontend (React + Tailwind) → Backend API (FastAPI) →
  ...
  - Claude API (reasoning/explanation, vision when image present, and Fraud Watch content gen)
...
- LLM: Claude API (vision-capable model) for reasoning + content generation
